...
// include: C:\Users\harri\AppData\Local\Temp\tmpv6tuh5b9.js
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/Pixellari.ttf", "start": 0, "end": 39908}, {"filename": "/assets/consume.wav", "start": 39908, "end": 109106, "audio": 1}, {"filename": "/assets/death.wav", "start": 109106, "end": 210560, "audio": 1}], "remote_package_size": 210560});

  })();

// end include: C:\Users\harri\AppData\Local\Temp\tmpv6tuh5b9.js
// include: C:\Users\harri\AppData\Local\Temp\tmpk7_p3a55.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\harri\AppData\Local\Temp\tmpk7_p3a55.js
// include: C:\Users\harri\AppData\Local\Temp\tmp3lr68g8_.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\harri\AppData\Local\Temp\tmp3lr68g8_.js
...
var ASM_CONSTS = {
  611832: () => { FS.mkdir("/save"); FS.mount(IDBFS, {}, "/save"); FS.syncfs(true, function (err) { if (err) { console.log("Error syncing filesystem: ", err); } else { ccall("filesystem_loaded", "void", [], []); } }); },  
 612032: () => { FS.syncfs(false, function (err) { if (err) { console.log("Error syncing to IndexedDB: ", err); } }); },  
 612133: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL); },  
 612358: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 612505: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 ...
 620783: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 620866: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 620935: () => { return window.innerWidth; },  
 620965: () => { return window.innerHeight; }
};

// Imports from the Wasm binary.
var _filesystem_loaded = Module['_filesystem_loaded'] = makeInvalidEarlyAccess('_filesystem_loaded');
...
function assignWasmExports(wasmExports) {
  Module['_filesystem_loaded'] = _filesystem_loaded = createExportWrapper('filesystem_loaded', 0);
